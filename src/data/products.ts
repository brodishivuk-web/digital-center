...
export const products: Product[] = [
  // ── שיווק ממומן ─────────────────────────────
  {
    ...
    syllabus: [
      {
        title: "בניית התשתית",
        items: ["פתיחת חשבון מדיה נכון", "התקנת מעקב המרות", "מבנה קמפיינים וקבוצות מודעות"],
      },
      {
        title: "הרצה ואופטימיזציה",
        items: ["כתיבת מודעות שממירות", "ניהול תקציב והצעות מחיר", "אופטימיזציה שבועית לפי דוחות"],
      },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "הקמה", items: ["Business Manager ופיקסל", "הגדרת קהלים", "תקציבים ומבנה קמפיין"] },
      { title: "יצירה ומדידה", items: ["קריאייטיב שממיר", "בדיקות A/B", "אופטימיזציה לפי נתונים"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "אסטרטגיה", items: ["משפכים רב-ערוציים", "שיוך המרות (Attribution)"], },
      { title: "סקייל", items: ["הרחבת תקציבים בבטחה", "בדיקות A/B מתקדמות", "דוחות ותובנות עסקיות"] },
    ],
  ...
  // ── שיווק אורגני ─────────────────────────────
  {
    ...
    syllabus: [
      { title: "בניית הבסיס", items: ["מיתוג הדף", "תבניות תוכן", "לוח תוכן חודשי"] },
      { title: "ניהול שוטף", items: ["תזמון ופרסום", "מענה ומכירה בצ'אט", "מדידת ביצועים"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "רעיון ותסריט", items: ["מציאת רעיונות מנצחים", "כתיבת תסריט קצר"] },
      { title: "צילום ועריכה", items: ["צילום מהיר בטלפון", "עריכה שמחזיקה צפייה"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "אסטרטגיה", items: ["עמודי תוכן", "מסרים חודשיים"] },
      { title: "ביצוע", items: ["לוח תוכן שנתי", "התאמה לכל רשת"] },
    ],
  ...
  // ── קידום אתרים ─────────────────────────────
  {
    ...
    syllabus: [
      { title: "יסודות", items: ["איך גוגל מדרג אתרים", "מחקר מילות מפתח"] },
      { title: "יישום", items: ["אופטימיזציית עמודים", "מבנה אתר וניווט", "מדידה עם Search Console"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "מחקר", items: ["כוונת חיפוש", "כלי מחקר מילות מפתח"] },
      { title: "כתיבה", items: ["מבנה עמוד", "כותרות ופתיחים"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "טכני", items: ["אבחון אתר", "מהירות טעינה", "נתונים מובנים"] },
      { title: "סמכות", items: ["בניית קישורים", "ניתוח מתחרים"] },
    ],
  ...
  // ── כלי AI ─────────────────────────────
  {
    ...
    syllabus: [
      { title: "יסודות", items: ["איך לכתוב פרומפט טוב", "ספריית פרומפטים לעסק"] },
      { title: "יישום", items: ["תוכן שיווקי מהיר", "אוטומציה למענה ללקוחות"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "תמונות", items: ["יצירת תמונות שיווקיות", "עיצוב באנרים"] },
      { title: "וידאו", items: ["יצירת קליפים מטקסט", "שדרוג תוכן קיים"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "בנייה", items: ["בניית תסריט שיחה", "חיבור כלי אוטומציה"] },
      { title: "הפעלה", items: ["איסוף לידים", "מעקב ושיפור ביצועים"] },
    ],
  ...
  // ── צילום ועריכה ─────────────────────────────
  {
    ...
    syllabus: [
      { title: "יסודות", items: ["תאורה נכונה", "קומפוזיציה"] },
      { title: "הפקה", items: ["צילום מוצרים", "בניית סט ביתי"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "יסודות עריכה", items: ["ממשק CapCut", "חיתוך קצבי"] },
      { title: "שדרוג", items: ["כתוביות וטקסט", "מוזיקה ואפקטים"] },
    ],
  ...
  },
  {
    ...
    syllabus: [
      { title: "מסר", items: ["מבנה סרטון מוכר", "קריאה לפעולה"] },
      { title: "הפקה", items: ["שילוב מוצר בתוכן", "סדרת סטוריז"] },
    ],
