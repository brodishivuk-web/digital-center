...
export const products: Product[] = [
  // ── שיווק ממומן ─────────────────────────────
  {
    ...
    level: "מתחילים",
    shortDescription:
      "בונים ומריצים קמפיין גוגל אדס ראשון עם השיטות העדכניות - Smart Bidding, נכסים ומשפך מלא.",
    description:
      "קורס מקיף שלוקח אתכם מאפס עד להרצת קמפיין גוגל אדס עובד, עם השיטות העדכניות שגוגל ממליץ עליהן היום - לא רק הבסיס הישן. 10 שיעורים מעמיקים ב-4 חלקים: יסודות ומבנה חשבון, מילות מפתח ואסטרטגיית הצעות מחיר, כתיבת מודעות ונכסים, ואופטימיזציה וסקייל.",
    highlights: [
      "בניית מבנה קמפיין וחשבון מגוגל אדס מאפס",
      "התאמת מילות מפתח ואסטרטגיות הצעות מחיר חכמות (Smart Bidding)",
      "כתיבת מודעות רספונסיביות ונכסים (Assets) שממירים",
      "בניית רשימת מילות מפתח שוללות שחוסכת תקציב",
      "בניית משפך רב-קמפיינים לצמיחה ולסקייל",
    ],
    syllabus: [
      {
        title: "יסודות ומבנה חשבון",
        items: ["פתיחת חשבון והתקנת מעקב המרות", "בחירת סוג הקמפיין הנכון", "מבנה קמפיינים וקבוצות מודעות"],
      },
      {
        title: "מילות מפתח ואסטרטגיית הצעות מחיר",
        items: ["סוגי התאמת מילות מפתח ו-Smart Bidding", "בניית רשימת מילות מפתח שוללות", "ניהול תקציב ואסטרטגיות הצעות מחיר"],
      },
      {
        title: "כתיבת מודעות ונכסים",
        items: ["כתיבת מודעות שממירות", "נכסי מודעה (Assets) - המדריך המלא"],
      },
      {
        title: "אופטימיזציה וסקייל",
        items: ["אופטימיזציה שבועית לפי דוחות", "בניית משפך רב-קמפיינים לצמיחה"],
      },
    ],
