...
export const products: Product[] = [
  ...
  // ── כלי AI ─────────────────────────────
  {
    ...
    description:
      "קורס מקיף לשימוש ב-ChatGPT בעסק - 10 שיעורים מעמיקים ב-4 חלקים: יסודות הפרומפט, תוכן שיווקי, שירות לקוחות ואוטומציה, ושימושים מתקדמים. כל שיעור כולל הסבר לעומק, כמה דוגמאות אמיתיות, טעויות נפוצות ותרגיל מעשי - וכולל ספריית פרומפטים מוכנה לשימוש.",
    highlights: [
      "נוסחת 5 המרכיבים לכתיבת פרומפט מנצח",
      "בניית ספריית פרומפטים אישית לעסק",
      "כתיבת פוסטים, מיילים ומאמרים שיווקיים",
      "אוטומציה למענה ללקוחות וטיפול בתלונות",
      "ניתוח נתונים עסקיים והוראות מותאמות אישית",
    ],
    syllabus: [
      {
        title: "יסודות הפרומפט",
        items: ["איך לכתוב פרומפט טוב", "5 המרכיבים של פרומפט מנצח", "עבודה עם שיחה מתמשכת ושיפור תוצאות"],
      },
      {
        title: "יצירת תוכן שיווקי",
        items: ["כתיבת פוסטים ומודעות לרשתות החברתיות", "כתיבת מיילים, ניוזלטרים ומאמרים ארוכים", "בניית ספריית פרומפטים אישית לעסק"],
      },
      {
        title: "שירות לקוחות ואוטומציה",
        items: ["אוטומציה חכמה למענה ללקוחות", "טיפול בתלונות ובמצבים רגישים בעזרת AI"],
      },
      {
        title: "שימושים מתקדמים לעסק",
        items: ["ניתוח נתונים עסקיים וקבלת החלטות בעזרת AI", "בניית תהליכי עבודה קבועים עם הוראות מותאמות אישית"],
      },
    ],
